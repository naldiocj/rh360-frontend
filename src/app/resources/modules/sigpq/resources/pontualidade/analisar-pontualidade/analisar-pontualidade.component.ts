...
@Component({
  selector: 'app-analisar-pontualidade',
  templateUrl: './analisar-pontualidade.component.html',
  styleUrls: ['./analisar-pontualidade.component.css']
})
export class AnalisarPontualidadeComponent  implements OnInit,OnDestroy {
