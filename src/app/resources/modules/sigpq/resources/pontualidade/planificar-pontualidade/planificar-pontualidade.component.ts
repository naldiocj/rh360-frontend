...
@Component({
  selector: 'app-planificar-pontualidade',
  templateUrl: './planificar-pontualidade.component.html',
  styleUrls: ['./planificar-pontualidade.component.css']
})
export class PlanificarPontualidadeComponent implements OnInit,OnDestroy {
