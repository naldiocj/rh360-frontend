...
@Component({
  selector: 'app-efectivo-especial',
  templateUrl: './efectivo-especial.component.html',
  styleUrls: ['./efectivo-especial.component.css']
})
export class EfectivoEspecialComponent implements OnInit {
  ...
  dashboards:any=[
    ...
    buscarDashboards() {
          this.isLoading = true;
          /* if(this.dashboardService.data_dashboard?.especial_efectivos_ativos) {this.isLoading = false;
            this.dashboards=this.informacao=='activo'?this.dashboardService.data_dashboard.especial_efectivos_ativos:this.dashboardService.data_dashboard.especial_efectivos_passivo
            ...
            this.dashboardService.listar_todos_nova_estrutura().pipe(
              ...
              this.dashboards=this.informacao=='activo'?this.dashboardService.data_dashboard.especial_efectivos_ativos:this.informacao=='inactivo'?this.dashboardService.data_dashboard.especial_efectivo_inactivo:this.dashboardService.data_dashboard.especial_efectivos_passivo
