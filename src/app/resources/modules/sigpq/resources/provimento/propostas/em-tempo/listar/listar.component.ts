...
export class ListarComponent implements OnInit {
  ...
  selecionarEsteAgenteParaMobilidade(funcionario: any,ordem:number) {
  ...
  selecionarTodosEfectivos(event: any) {
    this.emTempos.forEach((element: any, index:number) => {
