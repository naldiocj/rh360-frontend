...
export class ListarComponent implements OnInit {
  ...
  constructor(private utilizadoresServico: UtilizadorService, private direcaoOuOrgaoService: DirecaoOuOrgaoService, private estruturaOrganicaServico: TipoEstruturaOrganica, private sec: SecureService, private moduloService: ModuloService, private modalService: ModalService) { }
  ...
  buscarUtilizadores() {
    ...
    // this.isLoading = true;
    this.utilizadoresServico.listarTodos(options).pipe(
      finalize(() => {
