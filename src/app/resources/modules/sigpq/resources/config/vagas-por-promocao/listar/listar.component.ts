...
export class ListarComponent implements OnInit,AfterViewInit {
  ...
  constructor(private vagaparaPromocaoService:VagaParaPromocaoService) { }
  ...
  private buscarlicenca(): void {
    ...
    this.vagaparaPromocaoService.listar(options)
      .pipe(
        finalize((): void => {
      ...
      .subscribe((response: any): void => {
        ...
        console.log("Dados achados:",this.licencas)
      })
  }

  public eliminar(identificador:any)
  {
    this.vagaparaPromocaoService.eliminar(identificador).pipe(
      finalize(() => {
        this.buscarlicenca()
      })
  ...
  toggleActive(cargo:any)
  {
    ...
    this.vagaparaPromocaoService.alterarStadoActivo(formData,cargo.id).pipe(
      finalize(() => {
        this.buscarlicenca()
      })
    ).subscribe((sucess:any) => {
