...
export class VagaParaPromocaoService {

    public api: string = '/api/v1';
    public base: string = this.api + '/sigpq/config/vaga-promocao-proposta';
    ...
    alterarStadoActivo(formulario: any, id: any): Observable<any> {
      return this.httpApi
        .put(`${this.base}/alterarStadoActivo/${id}`, formulario)
        .pipe(
          debounceTime(500),
          map((response: any): any => {
            return response.object;
