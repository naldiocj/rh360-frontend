...
@Component({
  selector: 'app-listar-Agregado-Familiar',
  templateUrl: './listar-Agregado-Familiar.component.html',
  styleUrls: ['./listar-Agregado-Familiar.component.css']
})
export class ListarAgregadoFamiliarComponent implements OnInit {
