...
@Component({
  selector: 'app-nao-atribuidos',
  templateUrl: './nao-atribuidos.component.html',
  styleUrls: ['./nao-atribuidos.component.css']
})
export class NaoAtribuidosComponent implements OnInit {
