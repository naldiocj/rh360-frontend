...
import { GuiaService } from '@resources/modules/sigcode/core/service/guia.service';
import { Pagination } from '@shared/models/pagination';
import { catchError, finalize } from 'rxjs';

@Component({
  selector: 'app-historico-guia',
  templateUrl: './historico-guia.component.html',
  styleUrls: ['./historico-guia.component.css']
})

  export class HistoricoGuiaComponent implements OnInit {
