...
export class DelitousoTribulanResultadoProcessoService {


  public api: string = '/api/v1/sicgo';
  public base: string = this.api + '/dinfop_delitouso_resultado_processo';
  ...
  editar1(formulario: any, id: any): Observable<any> {
    return this.httpApi
