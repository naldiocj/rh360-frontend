...
@Component({
  selector: 'app-secretaria-expedientes',
  templateUrl: './secretaria-expedientes.component.html',
  styleUrls: ['./secretaria-expedientes.component.css']
})
export class SecretariaExpedientesComponent implements OnInit {
expedientes: any[] = [];
  public estados = [
    {
      cor: '#cc0000',
