...
import { AntecedenteAssociativaGruposService } from '@resources/modules/sicgo/core/service/piquete/associacao/antecedentes/antecedente_associativa_grupos/antecedente-associativa-grupos.service';
import { Select2OptionData } from 'ng-select2';
import { Validators } from 'ngx-editor';
import { finalize } from 'rxjs';

@Component({
  selector: 'sicgo-dinfop-antecedente-associacao-grupos',
  templateUrl: './antecedente-associacao-grupos.component.html',
  styleUrls: ['./antecedente-associacao-grupos.component.css']
})
export class AntecedenteAssociacaoGruposComponent implements OnInit {
  ...
  constructor(
    ...
    private antecedent: AntecedenteAssociativaGruposService) {
  ...
  onSubmit(): void {
    ...
    const formData = { ...this.registrationForm.value, associacao_id: this.getantecedenteId() };
  ...
  buscarId(): number | undefined {
    return this.associoId;
  }

  getantecedenteId(): number {
