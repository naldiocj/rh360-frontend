...
import { DinfopGrupoService } from '@resources/modules/sicgo/core/service/piquete/dinfop/grupo.service';
...
@Component({
  selector: 'app-registar-ou-editar-integrantes',
  templateUrl: './registar-ou-editar-integrantes.component.html',
  styleUrls: ['./registar-ou-editar-integrantes.component.css']
})
export class RegistarOuEditarIntegrantesComponent implements OnInit {
  options = {
  ...
  constructor(
    ...
    private dinfopService: DinfopGrupoService,
  ){}
