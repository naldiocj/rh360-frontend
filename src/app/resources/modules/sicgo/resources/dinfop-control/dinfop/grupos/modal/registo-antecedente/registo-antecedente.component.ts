...
import { AntecedentesGrupoService } from '@resources/modules/sicgo/core/service/piquete/dinfop/dinfop_grupo_antecedente/antecedentes-grupo.service';
import { Select2OptionData } from 'ng-select2';
import { finalize } from 'rxjs';

@Component({
  selector: 'sicgo-dinfop-grupo-registo-antecedente',
  templateUrl: './registo-antecedente.component.html',
  styleUrls: ['./registo-antecedente.component.css']
})
export class RegistoGrupoAntecedenteComponent implements OnInit {
  ...
  constructor(
    ...
    private antecedent: AntecedentesGrupoService) {
  ...
  onSubmit(): void {
    ...
    const formData = { ...this.registrationForm.value, grupo_id: this.getDelituosoId() };
