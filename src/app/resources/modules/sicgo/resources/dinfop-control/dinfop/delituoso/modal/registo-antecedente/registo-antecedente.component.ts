...
@Component({
  selector: 'sicgo-dinfop-delituoso-registo-antecedente',
  templateUrl: './registo-antecedente.component.html',
  styleUrls: ['./registo-antecedente.component.css']
})
export class RegistoAntecedenteComponent implements OnInit {
  ...
  constructor(
    ...
    private antecedent: DinfopAntecedenteDelitousoService) {
  ...
  ngOnInit(): void {
    ...
    this.antecedent.currentId.subscribe((modo) => {
      this.antecedente = modo;
  ...
  getDataForm(): void {
    ...
    this.registrationForm.patchValue({
      id:  this.antecedente.id,
      title:  this.antecedente.title,
