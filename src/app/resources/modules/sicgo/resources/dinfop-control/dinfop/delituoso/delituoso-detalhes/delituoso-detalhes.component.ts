...
@Component({
  selector: 'app-delituoso-detalhes',
  templateUrl: './delituoso-detalhes.component.html',
  styleUrls: ['./delituoso-detalhes.component.css']
})
export class DelituosoDetalhesComponent implements OnInit {
  delituosoId: any;
  ...
  ngOnInit(): void {
    ...
    if (encodedId) {
      ...
      this.delituosoId =  encodedId; // Decodifica o ID do base64
