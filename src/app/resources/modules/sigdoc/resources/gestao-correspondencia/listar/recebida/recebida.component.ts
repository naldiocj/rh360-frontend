...
@Component({
  selector: 'app-recebida',
  templateUrl: './recebida.component.html',
  styleUrls: ['./recebida.component.css']
})
export class RecebidaComponent implements OnInit, OnDestroy {
  @Input() item: any;
  ...
  private startPolling(): void {
    ...
    this.pollingSubscription = this.correspondenciaService.startPolling(options).subscribe({
