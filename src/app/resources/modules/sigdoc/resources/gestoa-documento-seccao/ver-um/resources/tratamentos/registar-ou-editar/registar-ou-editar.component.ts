...
import { TratamentoSeccaoService } from '@resources/modules/sigdoc/core/service/Tratamento-seccao.service';
...
export class RegistarOuEditarComponent implements OnInit, OnChanges {
  ...
  constructor(
    ...
    private tratamentoSeccaoService: TratamentoSeccaoService,
  ...
  public onSubmit() {
    ...
    const type = this.getId
      ? this.tratamentoSeccaoService.editar(formData, this.getId)
      : this.tratamentoSeccaoService.registar(formData);
  ...
  public get dataForm() {
    ...
    data.append(
      'sigdoc_seccao_id',
      this.simpleForm.get('sigdoc_seccao_id')?.value
    );
  ...
  public reiniciarFormulario() {
    ...
    this.simpleForm.patchValue({
      ...
      sigdoc_seccao_id: this.getCorrespondenciaId,
    });
    $('file-anexo').val('');
