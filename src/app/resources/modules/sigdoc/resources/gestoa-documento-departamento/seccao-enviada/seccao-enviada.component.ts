...
@Component({
  selector: 'app-seccao-enviada',
  templateUrl: './seccao-enviada.component.html',
  styleUrls: ['./seccao-enviada.component.css']
})
export class SeccaoEnviadaComponent implements OnInit {
