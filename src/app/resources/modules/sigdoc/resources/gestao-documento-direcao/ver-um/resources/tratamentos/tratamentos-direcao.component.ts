...
@Component({
  ...
  templateUrl: './tratamentos-direcao.component.html',
  styleUrls: ['./tratamentos-direcao.component.css'],
})
export class TratamentosDirecaoComponent implements OnInit, OnChanges {
