...
export class ListarComponent implements OnInit {
  ...
  constructor(private correspondenciaService: ArquivoDigitalService, private ficheiroService: FicheiroService, private secureService: SecureService) {
  ...
  confirmarEliminar(): void {
    if (this.arquivoIdParaExcluir) {
      this.correspondenciaService.eliminar(this.arquivoIdParaExcluir).subscribe(
        () => {
