...
@Component({
  selector: 'app-solicitacoes-direcoes-pendentes',
  templateUrl: './solicitacoes-direcoes-pendentes.component.html',
  styleUrls: ['./solicitacoes-direcoes-pendentes.component.css']
})
export class SolicitacoesDirecoesPendentesComponent implements OnInit {
