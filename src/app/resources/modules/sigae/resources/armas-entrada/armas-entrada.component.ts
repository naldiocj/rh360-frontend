...
@Component({
  selector: 'app-armas-entrada',
  templateUrl: './armas-entrada.component.html',
  styleUrls: ['./armas-entrada.component.css'],
})
export class ArmasEntradaComponent implements OnInit {
