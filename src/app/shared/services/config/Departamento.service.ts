...
export class DepartamentoService implements InterfaceService {
 
    public base: string = environment.api_url_by_version + '/sigpq/config/departamento';
